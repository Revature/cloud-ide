...
async def create_security_group(
    ...
    try:
        ...
        db_security_group = security_group_repository.add_security_group(new_security_group)
        # session.commit()
...
async def authorize_user_access(runner_id: int, user_ip: str, user_email: str, cloud_service, port: int = 4200) -> bool:
    ...
    try:
        ...
        for sg in security_groups:
            ...
            security_group_repository.update_security_group(sg)
    ...
    try:
        ...
        if security_group:
            ...
            if result == success_status_code:
                ...
                security_group_repository.update_security_group(security_group)
            else:
