...
def update_cloud_connector(session: Session, cloud_connector_id: int, cloud_connector_data: CloudConnector) -> CloudConnector:
...
def update_connector_status(session: Session, cloud_connector_id: int, is_active: bool) -> CloudConnector:
    """
    ...
    cloud_connector = find_cloud_connector_by_id(session, cloud_connector_id)
