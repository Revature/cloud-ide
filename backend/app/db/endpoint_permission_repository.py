...
def find_all_endpoint_permissions(session: Session) -> list[EndpointPermission]:
    """Select all endpoint permissions."""
    statement = select(EndpointPermission)
    return session.exec(statement).all()

def find_endpoint_permission_by_id(session: Session, id: int) -> Optional[EndpointPermission]:
...
def delete_endpoint_permission(session: Session, endpoint_permission_id: int) -> bool:
