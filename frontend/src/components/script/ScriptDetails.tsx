            ...
            {!scripts || scripts.length === 0 ? (
              <TableRow className="hover:bg-gray-50 dark:hover:bg-white/[0.03] text-center col-span-4">
                <span className="text-gray-600 dark:text-gray-300">
                  No scripts available for this image. Please add scripts if needed.
                </span>
              </TableRow>
            ) : (
              scripts.map((script) => (
                  ...
                  <TableCell className="px-4 py-4 text-sm text-gray-700 dark:text-gray-400 text-right">
                    <div className="relative">
                      ...
                      {activeDropdown === script.id && (
                        <div
                          className="absolute right-1 top-full mt-1 w-36 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg z-10"
